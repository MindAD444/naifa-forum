...
(function (beyondcorp_v1alpha) {
    ...
    class Resource$Projects$Locations$Applicationdomains {
        context;
        constructor(context) {
            this.context = context;
        }
    ...
    beyondcorp_v1alpha.Resource$Projects$Locations$Applicationdomains = Resource$Projects$Locations$Applicationdomains;
    ...
    class Resource$Projects$Locations$Securitygateways {
        ...
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1alpha/{+parent}/securityGateways').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    beyondcorp_v1alpha.Resource$Projects$Locations$Securitygateways = Resource$Projects$Locations$Securitygateways;
    ...
    beyondcorp_v1alpha.Resource$Projects$Locations$Securitygateways$Applications = Resource$Projects$Locations$Securitygateways$Applications;
