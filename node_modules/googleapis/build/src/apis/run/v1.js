...
(function (run_v1) {
    ...
    class Resource$Namespaces$Workerpools {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/apis/run.googleapis.com/v1/{+parent}/workerpools').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
        ...
        replaceWorkerPool(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
    ...
    run_v1.Resource$Namespaces$Workerpools = Resource$Namespaces$Workerpools;
    ...
    run_v1.Resource$Projects$Locations$Operations = Resource$Projects$Locations$Operations;
    ...
    run_v1.Resource$Projects$Locations$Workerpools = Resource$Projects$Locations$Workerpools;
})(run_v1 || (exports.run_v1 = run_v1 = {}));
