...
(function (safebrowsing_v5) {
    ...
    class Resource$Hashlist {
        ...
        get(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v5/hashList/{name}').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    safebrowsing_v5.Resource$Hashlist = Resource$Hashlist;
    class Resource$Hashlists {
        context;
        constructor(context) {
            this.context = context;
        }
        batchGet(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v5/hashLists:batchGet').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    safebrowsing_v5.Resource$Hashlists = Resource$Hashlists;
