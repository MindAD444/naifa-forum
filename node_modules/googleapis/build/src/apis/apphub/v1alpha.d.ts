...
export declare namespace apphub_v1alpha {
    ...
    export class Resource$Projects$Locations$Discoveredservices {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        findUnregistered(params: Params$Resource$Projects$Locations$Discoveredservices$Findunregistered, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        findUnregistered(params?: Params$Resource$Projects$Locations$Discoveredservices$Findunregistered, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FindUnregisteredServicesResponse>>;
        findUnregistered(params: Params$Resource$Projects$Locations$Discoveredservices$Findunregistered, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        findUnregistered(params: Params$Resource$Projects$Locations$Discoveredservices$Findunregistered, options: MethodOptions | BodyResponseCallback<Schema$FindUnregisteredServicesResponse>, callback: BodyResponseCallback<Schema$FindUnregisteredServicesResponse>): void;
        findUnregistered(params: Params$Resource$Projects$Locations$Discoveredservices$Findunregistered, callback: BodyResponseCallback<Schema$FindUnregisteredServicesResponse>): void;
        findUnregistered(callback: BodyResponseCallback<Schema$FindUnregisteredServicesResponse>): void;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Discoveredservices$Findunregistered extends StandardParameters {
        /**
         * Optional. Filtering results.
         */
        filter?: string;
    ...
    export class Resource$Projects$Locations$Discoveredworkloads {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        findUnregistered(params: Params$Resource$Projects$Locations$Discoveredworkloads$Findunregistered, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        findUnregistered(params?: Params$Resource$Projects$Locations$Discoveredworkloads$Findunregistered, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FindUnregisteredWorkloadsResponse>>;
        findUnregistered(params: Params$Resource$Projects$Locations$Discoveredworkloads$Findunregistered, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        findUnregistered(params: Params$Resource$Projects$Locations$Discoveredworkloads$Findunregistered, options: MethodOptions | BodyResponseCallback<Schema$FindUnregisteredWorkloadsResponse>, callback: BodyResponseCallback<Schema$FindUnregisteredWorkloadsResponse>): void;
        findUnregistered(params: Params$Resource$Projects$Locations$Discoveredworkloads$Findunregistered, callback: BodyResponseCallback<Schema$FindUnregisteredWorkloadsResponse>): void;
        findUnregistered(callback: BodyResponseCallback<Schema$FindUnregisteredWorkloadsResponse>): void;
        /**
    ...
    export interface Params$Resource$Projects$Locations$Discoveredworkloads$Findunregistered extends StandardParameters {
        /**
         * Optional. Filtering results.
         */
        filter?: string;
