...
(function (backupdr_v1) {
    ...
    class Resource$Projects$Locations {
        ...
        getTrial(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
    ...
    class Resource$Projects$Locations$Backupplanassociations {
        ...
        fetchForResourceType(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v1/{+parent}/backupPlanAssociations:fetchForResourceType').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    class Resource$Projects$Locations$Backupplans {
        ...
        constructor(context) {
            this.context = context;
            this.revisions = new Resource$Projects$Locations$Backupplans$Revisions(this.context);
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
    ...
    class Resource$Projects$Locations$Backupplans$Revisions {
        context;
        constructor(context) {
            this.context = context;
        }
    ...
    backupdr_v1.Resource$Projects$Locations$Backupplans$Revisions = Resource$Projects$Locations$Backupplans$Revisions;
    ...
    class Resource$Projects$Locations$Datasourcereferences {
        context;
        constructor(context) {
            this.context = context;
        }
        fetchForResourceType(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl +
                        '/v1/{+parent}/dataSourceReferences:fetchForResourceType').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    backupdr_v1.Resource$Projects$Locations$Datasourcereferences = Resource$Projects$Locations$Datasourcereferences;
    class Resource$Projects$Locations$Managementservers {
        ...
        msComplianceMetadata(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}:msComplianceMetadata').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    class Resource$Projects$Locations$Trial {
        context;
        constructor(context) {
            this.context = context;
        }
        subscribe(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/trial:subscribe').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    backupdr_v1.Resource$Projects$Locations$Trial = Resource$Projects$Locations$Trial;
