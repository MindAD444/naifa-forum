...
export declare namespace backupdr_v1 {
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getTrial(params: Params$Resource$Projects$Locations$Gettrial, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getTrial(params?: Params$Resource$Projects$Locations$Gettrial, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Trial>>;
        getTrial(params: Params$Resource$Projects$Locations$Gettrial, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getTrial(params: Params$Resource$Projects$Locations$Gettrial, options: MethodOptions | BodyResponseCallback<Schema$Trial>, callback: BodyResponseCallback<Schema$Trial>): void;
        getTrial(params: Params$Resource$Projects$Locations$Gettrial, callback: BodyResponseCallback<Schema$Trial>): void;
    ...
    export class Resource$Projects$Locations$Backupplanassociations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchForResourceType(params: Params$Resource$Projects$Locations$Backupplanassociations$Fetchforresourcetype, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchForResourceType(params?: Params$Resource$Projects$Locations$Backupplanassociations$Fetchforresourcetype, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchBackupPlanAssociationsForResourceTypeResponse>>;
        fetchForResourceType(params: Params$Resource$Projects$Locations$Backupplanassociations$Fetchforresourcetype, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetchForResourceType(params: Params$Resource$Projects$Locations$Backupplanassociations$Fetchforresourcetype, options: MethodOptions | BodyResponseCallback<Schema$FetchBackupPlanAssociationsForResourceTypeResponse>, callback: BodyResponseCallback<Schema$FetchBackupPlanAssociationsForResourceTypeResponse>): void;
        fetchForResourceType(params: Params$Resource$Projects$Locations$Backupplanassociations$Fetchforresourcetype, callback: BodyResponseCallback<Schema$FetchBackupPlanAssociationsForResourceTypeResponse>): void;
        fetchForResourceType(callback: BodyResponseCallback<Schema$FetchBackupPlanAssociationsForResourceTypeResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Backupplanassociations$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Backupplanassociations$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        patch(params: Params$Resource$Projects$Locations$Backupplanassociations$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Backupplanassociations$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Projects$Locations$Backupplanassociations$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    export class Resource$Projects$Locations$Backupplans {
        ...
        patch(params?: Params$Resource$Projects$Locations$Backupplans$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        ...
        patch(params: Params$Resource$Projects$Locations$Backupplans$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Projects$Locations$Backupplans$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(callback: BodyResponseCallback<Schema$Operation>): void;
    }
    ...
    export class Resource$Projects$Locations$Backupplans$Revisions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Backupplans$Revisions$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Backupplans$Revisions$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$BackupPlanRevision>>;
        get(params: Params$Resource$Projects$Locations$Backupplans$Revisions$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Backupplans$Revisions$Get, options: MethodOptions | BodyResponseCallback<Schema$BackupPlanRevision>, callback: BodyResponseCallback<Schema$BackupPlanRevision>): void;
        get(params: Params$Resource$Projects$Locations$Backupplans$Revisions$Get, callback: BodyResponseCallback<Schema$BackupPlanRevision>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Backupplans$Revisions$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Backupplans$Revisions$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ListBackupPlanRevisionsResponse>>;
        list(params: Params$Resource$Projects$Locations$Backupplans$Revisions$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Backupplans$Revisions$List, options: MethodOptions | BodyResponseCallback<Schema$ListBackupPlanRevisionsResponse>, callback: BodyResponseCallback<Schema$ListBackupPlanRevisionsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Backupplans$Revisions$List, callback: BodyResponseCallback<Schema$ListBackupPlanRevisionsResponse>): void;
        list(callback: BodyResponseCallback<Schema$ListBackupPlanRevisionsResponse>): void;
    }
    ...
    export class Resource$Projects$Locations$Datasourcereferences {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchForResourceType(params: Params$Resource$Projects$Locations$Datasourcereferences$Fetchforresourcetype, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchForResourceType(params?: Params$Resource$Projects$Locations$Datasourcereferences$Fetchforresourcetype, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchDataSourceReferencesForResourceTypeResponse>>;
        fetchForResourceType(params: Params$Resource$Projects$Locations$Datasourcereferences$Fetchforresourcetype, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        fetchForResourceType(params: Params$Resource$Projects$Locations$Datasourcereferences$Fetchforresourcetype, options: MethodOptions | BodyResponseCallback<Schema$FetchDataSourceReferencesForResourceTypeResponse>, callback: BodyResponseCallback<Schema$FetchDataSourceReferencesForResourceTypeResponse>): void;
        fetchForResourceType(params: Params$Resource$Projects$Locations$Datasourcereferences$Fetchforresourcetype, callback: BodyResponseCallback<Schema$FetchDataSourceReferencesForResourceTypeResponse>): void;
        fetchForResourceType(callback: BodyResponseCallback<Schema$FetchDataSourceReferencesForResourceTypeResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Datasourcereferences$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Datasourcereferences$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$DataSourceReference>>;
        get(params: Params$Resource$Projects$Locations$Datasourcereferences$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Datasourcereferences$Get, options: MethodOptions | BodyResponseCallback<Schema$DataSourceReference>, callback: BodyResponseCallback<Schema$DataSourceReference>): void;
        get(params: Params$Resource$Projects$Locations$Datasourcereferences$Get, callback: BodyResponseCallback<Schema$DataSourceReference>): void;
    ...
    export class Resource$Projects$Locations$Managementservers {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        msComplianceMetadata(params: Params$Resource$Projects$Locations$Managementservers$Mscompliancemetadata, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        msComplianceMetadata(params?: Params$Resource$Projects$Locations$Managementservers$Mscompliancemetadata, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$FetchMsComplianceMetadataResponse>>;
        msComplianceMetadata(params: Params$Resource$Projects$Locations$Managementservers$Mscompliancemetadata, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        msComplianceMetadata(params: Params$Resource$Projects$Locations$Managementservers$Mscompliancemetadata, options: MethodOptions | BodyResponseCallback<Schema$FetchMsComplianceMetadataResponse>, callback: BodyResponseCallback<Schema$FetchMsComplianceMetadataResponse>): void;
        msComplianceMetadata(params: Params$Resource$Projects$Locations$Managementservers$Mscompliancemetadata, callback: BodyResponseCallback<Schema$FetchMsComplianceMetadataResponse>): void;
        msComplianceMetadata(callback: BodyResponseCallback<Schema$FetchMsComplianceMetadataResponse>): void;
        /**
    ...
    export class Resource$Projects$Locations$Trial {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        subscribe(params: Params$Resource$Projects$Locations$Trial$Subscribe, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        subscribe(params?: Params$Resource$Projects$Locations$Trial$Subscribe, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Trial>>;
        subscribe(params: Params$Resource$Projects$Locations$Trial$Subscribe, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        subscribe(params: Params$Resource$Projects$Locations$Trial$Subscribe, options: MethodOptions | BodyResponseCallback<Schema$Trial>, callback: BodyResponseCallback<Schema$Trial>): void;
        subscribe(params: Params$Resource$Projects$Locations$Trial$Subscribe, callback: BodyResponseCallback<Schema$Trial>): void;
