...
export declare namespace tpu_v2alpha1 {
    ...
    export class Resource$Projects$Locations$Nodes {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        performMaintenance(params: Params$Resource$Projects$Locations$Nodes$Performmaintenance, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        performMaintenance(params?: Params$Resource$Projects$Locations$Nodes$Performmaintenance, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        performMaintenance(params: Params$Resource$Projects$Locations$Nodes$Performmaintenance, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        performMaintenance(params: Params$Resource$Projects$Locations$Nodes$Performmaintenance, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        performMaintenance(params: Params$Resource$Projects$Locations$Nodes$Performmaintenance, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        simulateMaintenanceEvent(params: Params$Resource$Projects$Locations$Nodes$Simulatemaintenanceevent, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        simulateMaintenanceEvent(params?: Params$Resource$Projects$Locations$Nodes$Simulatemaintenanceevent, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
    ...
    export class Resource$Projects$Locations$Queuedresources {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getMaintenanceInfo(params: Params$Resource$Projects$Locations$Queuedresources$Getmaintenanceinfo, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getMaintenanceInfo(params?: Params$Resource$Projects$Locations$Queuedresources$Getmaintenanceinfo, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GetMaintenanceInfoResponse>>;
        getMaintenanceInfo(params: Params$Resource$Projects$Locations$Queuedresources$Getmaintenanceinfo, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getMaintenanceInfo(params: Params$Resource$Projects$Locations$Queuedresources$Getmaintenanceinfo, options: MethodOptions | BodyResponseCallback<Schema$GetMaintenanceInfoResponse>, callback: BodyResponseCallback<Schema$GetMaintenanceInfoResponse>): void;
        getMaintenanceInfo(params: Params$Resource$Projects$Locations$Queuedresources$Getmaintenanceinfo, callback: BodyResponseCallback<Schema$GetMaintenanceInfoResponse>): void;
        getMaintenanceInfo(callback: BodyResponseCallback<Schema$GetMaintenanceInfoResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        performMaintenanceQueuedResource(params: Params$Resource$Projects$Locations$Queuedresources$Performmaintenancequeuedresource, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        performMaintenanceQueuedResource(params?: Params$Resource$Projects$Locations$Queuedresources$Performmaintenancequeuedresource, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        performMaintenanceQueuedResource(params: Params$Resource$Projects$Locations$Queuedresources$Performmaintenancequeuedresource, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        performMaintenanceQueuedResource(params: Params$Resource$Projects$Locations$Queuedresources$Performmaintenancequeuedresource, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        performMaintenanceQueuedResource(params: Params$Resource$Projects$Locations$Queuedresources$Performmaintenancequeuedresource, callback: BodyResponseCallback<Schema$Operation>): void;
