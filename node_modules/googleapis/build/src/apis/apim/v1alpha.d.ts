...
export declare namespace apim_v1alpha {
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getEntitlement(params: Params$Resource$Projects$Locations$Getentitlement, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getEntitlement(params?: Params$Resource$Projects$Locations$Getentitlement, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Entitlement>>;
        getEntitlement(params: Params$Resource$Projects$Locations$Getentitlement, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getEntitlement(params: Params$Resource$Projects$Locations$Getentitlement, options: MethodOptions | BodyResponseCallback<Schema$Entitlement>, callback: BodyResponseCallback<Schema$Entitlement>): void;
        getEntitlement(params: Params$Resource$Projects$Locations$Getentitlement, callback: BodyResponseCallback<Schema$Entitlement>): void;
