...
(function (artifactregistry_v1) {
    ...
    class Resource$Projects$Locations$Repositories {
        ...
        constructor(context) {
            ...
            this.rules = new Resource$Projects$Locations$Repositories$Rules(this.context);
            this.yumArtifacts =
    ...
    class Resource$Projects$Locations$Repositories$Attachments {
        context;
        constructor(context) {
            this.context = context;
        }
    ...
    artifactregistry_v1.Resource$Projects$Locations$Repositories$Attachments = Resource$Projects$Locations$Repositories$Attachments;
    ...
    class Resource$Projects$Locations$Repositories$Files {
        ...
        upload(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/files:upload').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
                mediaUrl: (rootUrl + '/upload/v1/{+parent}/files:upload').replace(/([^:]\/)\/+/g, '$1'),
                requiredParams: ['parent'],
                pathParams: ['parent'],
                context: this.context,
            };
    ...
    class Resource$Projects$Locations$Repositories$Rules {
        context;
        constructor(context) {
            this.context = context;
        }
    ...
    artifactregistry_v1.Resource$Projects$Locations$Repositories$Rules = Resource$Projects$Locations$Repositories$Rules;
