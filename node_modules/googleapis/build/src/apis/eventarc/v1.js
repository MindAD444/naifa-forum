...
(function (eventarc_v1) {
    ...
    class Resource$Projects$Locations {
        ...
        constructor(context) {
            ...
            this.enrollments = new Resource$Projects$Locations$Enrollments(this.context);
            this.googleApiSources = new Resource$Projects$Locations$Googleapisources(this.context);
            this.kafkaSources = new Resource$Projects$Locations$Kafkasources(this.context);
            this.messageBuses = new Resource$Projects$Locations$Messagebuses(this.context);
    ...
    class Resource$Projects$Locations$Enrollments {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/enrollments').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    eventarc_v1.Resource$Projects$Locations$Enrollments = Resource$Projects$Locations$Enrollments;
    class Resource$Projects$Locations$Googleapisources {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/googleApiSources').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    eventarc_v1.Resource$Projects$Locations$Googleapisources = Resource$Projects$Locations$Googleapisources;
    class Resource$Projects$Locations$Kafkasources {
        context;
        constructor(context) {
            this.context = context;
        }
    ...
    eventarc_v1.Resource$Projects$Locations$Kafkasources = Resource$Projects$Locations$Kafkasources;
    class Resource$Projects$Locations$Messagebuses {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/messageBuses').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
        ...
        listEnrollments(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}:listEnrollments').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: '',
                }, options),
                params,
    ...
    eventarc_v1.Resource$Projects$Locations$Messagebuses = Resource$Projects$Locations$Messagebuses;
    ...
    eventarc_v1.Resource$Projects$Locations$Pipelines = Resource$Projects$Locations$Pipelines;
...
})(eventarc_v1 || (exports.eventarc_v1 = eventarc_v1 = {}));
