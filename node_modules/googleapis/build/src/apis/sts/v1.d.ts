...
export declare namespace sts_v1 {
    ...
    export class Resource$V1 {
         ...
         */
        token(params: Params$Resource$V1$Token, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        token(params?: Params$Resource$V1$Token, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleIdentityStsV1ExchangeTokenResponse>>;
