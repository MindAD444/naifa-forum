...
export declare namespace firebasehosting_v1 {
    ...
    export class Resource$Projects$Sites$Customdomains$Operations {
         ...
         *   // Do the magic
         *   const res =
         *     await firebasehosting.projects.sites.customDomains.operations.cancel({
         *       // The name of the operation resource to be cancelled.
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        cancel(params: Params$Resource$Projects$Sites$Customdomains$Operations$Cancel, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        cancel(params?: Params$Resource$Projects$Sites$Customdomains$Operations$Cancel, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
         ...
         *   // Do the magic
         *   const res =
         *     await firebasehosting.projects.sites.customDomains.operations.delete({
         *       // The name of the operation resource to be deleted.
         *       name: 'projects/my-project/sites/my-site/customDomains/my-customDomain/operations/my-operation',
         *     });
         *   console.log(res.data);
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Sites$Customdomains$Operations$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Sites$Customdomains$Operations$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Empty>>;
