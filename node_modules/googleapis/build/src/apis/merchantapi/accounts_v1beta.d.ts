...
export declare namespace merchantapi_accounts_v1beta {
    ...
    export class Resource$Accounts$Onlinereturnpolicies {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Accounts$Onlinereturnpolicies$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Accounts$Onlinereturnpolicies$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$OnlineReturnPolicy>>;
        patch(params: Params$Resource$Accounts$Onlinereturnpolicies$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Accounts$Onlinereturnpolicies$Patch, options: MethodOptions | BodyResponseCallback<Schema$OnlineReturnPolicy>, callback: BodyResponseCallback<Schema$OnlineReturnPolicy>): void;
        patch(params: Params$Resource$Accounts$Onlinereturnpolicies$Patch, callback: BodyResponseCallback<Schema$OnlineReturnPolicy>): void;
    ...
    export interface Params$Resource$Accounts$Onlinereturnpolicies$Patch extends StandardParameters {
        /**
         * Identifier. The name of the `OnlineReturnPolicy` resource. Format: `accounts/{account\}/onlineReturnPolicies/{return_policy\}`
         */
        name?: string;
