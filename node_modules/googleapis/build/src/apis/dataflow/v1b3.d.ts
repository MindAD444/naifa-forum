...
export declare namespace dataflow_v1b3 {
    ...
    export class Resource$Projects$Locations$Jobs$Debug {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getWorkerStacktraces(params: Params$Resource$Projects$Locations$Jobs$Debug$Getworkerstacktraces, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getWorkerStacktraces(params?: Params$Resource$Projects$Locations$Jobs$Debug$Getworkerstacktraces, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GetWorkerStacktracesResponse>>;
        getWorkerStacktraces(params: Params$Resource$Projects$Locations$Jobs$Debug$Getworkerstacktraces, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getWorkerStacktraces(params: Params$Resource$Projects$Locations$Jobs$Debug$Getworkerstacktraces, options: MethodOptions | BodyResponseCallback<Schema$GetWorkerStacktracesResponse>, callback: BodyResponseCallback<Schema$GetWorkerStacktracesResponse>): void;
        getWorkerStacktraces(params: Params$Resource$Projects$Locations$Jobs$Debug$Getworkerstacktraces, callback: BodyResponseCallback<Schema$GetWorkerStacktracesResponse>): void;
        getWorkerStacktraces(callback: BodyResponseCallback<Schema$GetWorkerStacktracesResponse>): void;
        /**
         * Send encoded debug capture data for component.
         * @example
         * ```js
