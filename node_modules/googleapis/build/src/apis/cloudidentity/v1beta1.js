...
(function (cloudidentity_v1beta1) {
    ...
    class Cloudidentity {
        ...
        constructor(options, google) {
            ...
            this.inboundOidcSsoProfiles = new Resource$Inboundoidcssoprofiles(this.context);
    ...
    class Resource$Inboundoidcssoprofiles {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta1/inboundOidcSsoProfiles').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    cloudidentity_v1beta1.Resource$Inboundoidcssoprofiles = Resource$Inboundoidcssoprofiles;
