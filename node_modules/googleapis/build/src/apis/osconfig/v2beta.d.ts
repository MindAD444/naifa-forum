...
export declare namespace osconfig_v2beta {
    ...
    export class Resource$Folders$Locations$Global$Policyorchestrators {
         ...
         */
        create(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Folders$Locations$Global$Policyorchestrators$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        create(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Create, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Folders$Locations$Global$Policyorchestrators$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Folders$Locations$Global$Policyorchestrators$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>>;
        get(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>): void;
        get(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Get, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Folders$Locations$Global$Policyorchestrators$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>>;
        list(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>): void;
        list(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$List, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Folders$Locations$Global$Policyorchestrators$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        patch(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Folders$Locations$Global$Policyorchestrators$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
    ...
    export class Resource$Organizations$Locations$Global$Policyorchestrators {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        create(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Create, callback: BodyResponseCallback<Schema$Operation>): void;
        create(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>>;
        get(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>): void;
        get(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Get, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Organizations$Locations$Global$Policyorchestrators$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>>;
        list(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>): void;
        list(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$List, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        patch(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Organizations$Locations$Global$Policyorchestrators$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(callback: BodyResponseCallback<Schema$Operation>): void;
    }
    ...
    export class Resource$Projects$Locations$Global$Policyorchestrators {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Projects$Locations$Global$Policyorchestrators$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        create(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Create, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        create(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Create, callback: BodyResponseCallback<Schema$Operation>): void;
        create(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Projects$Locations$Global$Policyorchestrators$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        delete(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Delete, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Delete, callback: BodyResponseCallback<Schema$Operation>): void;
        delete(callback: BodyResponseCallback<Schema$Operation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Projects$Locations$Global$Policyorchestrators$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>>;
        get(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>): void;
        get(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Get, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>): void;
        get(callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__PolicyOrchestrator>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Projects$Locations$Global$Policyorchestrators$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>>;
        list(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>): void;
        list(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$List, callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleCloudOsconfigV2beta__ListPolicyOrchestratorsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Projects$Locations$Global$Policyorchestrators$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
        patch(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Patch, options: MethodOptions | BodyResponseCallback<Schema$Operation>, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(params: Params$Resource$Projects$Locations$Global$Policyorchestrators$Patch, callback: BodyResponseCallback<Schema$Operation>): void;
        patch(callback: BodyResponseCallback<Schema$Operation>): void;
    }
