...
(function (saasservicemgmt_v1beta1) {
    ...
    class Resource$Projects$Locations$Replicationsinternal {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1beta1/{+parent}/replicationsInternal').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    saasservicemgmt_v1beta1.Resource$Projects$Locations$Replicationsinternal = Resource$Projects$Locations$Replicationsinternal;
