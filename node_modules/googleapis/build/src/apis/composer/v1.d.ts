...
export declare namespace composer_v1 {
    ...
    export class Resource$Projects$Locations$Environments {
         ...
         *
         *   // Do the magic
         *   const res = await composer.projects.locations.environments.databaseFailover({
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.executeAirflowCommand({
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.fetchDatabaseProperties({
         ...
         *   // Example response
         *   // {
         *   //   "isFailoverReplicaAvailable": false,
         *   //   "primaryGceZone": "my_primaryGceZone",
         ...
         *
         *   // Do the magic
         *   const res = await composer.projects.locations.environments.pollAirflowCommand(
         *     {
         *       // The resource name of the environment in the form: "projects/{projectId\}/locations/{locationId\}/environments/{environmentId\}"
         *       environment:
         *         'projects/my-project/locations/my-location/environments/my-environment',
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        restartWebServer(params: Params$Resource$Projects$Locations$Environments$Restartwebserver, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        restartWebServer(params?: Params$Resource$Projects$Locations$Environments$Restartwebserver, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Operation>>;
         ...
         *
         *   // Do the magic
         *   const res = await composer.projects.locations.environments.stopAirflowCommand(
         *     {
         *       // The resource name of the environment in the form: "projects/{projectId\}/locations/{locationId\}/environments/{environmentId\}".
         *       environment:
         *         'projects/my-project/locations/my-location/environments/my-environment',
    ...
    export class Resource$Projects$Locations$Environments$Userworkloadsconfigmaps {
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.userWorkloadsConfigMaps.create(
         *       {
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.userWorkloadsConfigMaps.delete(
         *       {
         ...
         *         name: 'projects/my-project/locations/my-location/environments/my-environment/userWorkloadsConfigMaps/my-userWorkloadsConfigMap',
         *       },
         *     );
         *   console.log(res.data);
         *
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.userWorkloadsConfigMaps.get({
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.userWorkloadsConfigMaps.list(
         *       {
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.userWorkloadsConfigMaps.update(
         *       {
         *         // Identifier. The resource name of the ConfigMap, in the form: "projects/{projectId\}/locations/{locationId\}/environments/{environmentId\}/userWorkloadsConfigMaps/{userWorkloadsConfigMapId\}"
         *         name: 'projects/my-project/locations/my-location/environments/my-environment/userWorkloadsConfigMaps/my-userWorkloadsConfigMap',
         *
    ...
    export class Resource$Projects$Locations$Environments$Userworkloadssecrets {
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.userWorkloadsSecrets.create({
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.userWorkloadsSecrets.delete({
         ...
         *       name: 'projects/my-project/locations/my-location/environments/my-environment/userWorkloadsSecrets/my-userWorkloadsSecret',
         *     });
         *   console.log(res.data);
         *
         *   // Example response
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.userWorkloadsSecrets.get({
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.userWorkloadsSecrets.list({
         ...
         *   // Do the magic
         *   const res =
         *     await composer.projects.locations.environments.userWorkloadsSecrets.update({
         *       // Identifier. The resource name of the Secret, in the form: "projects/{projectId\}/locations/{locationId\}/environments/{environmentId\}/userWorkloadsSecrets/{userWorkloadsSecretId\}"
         *       name: 'projects/my-project/locations/my-location/environments/my-environment/userWorkloadsSecrets/my-userWorkloadsSecret',
         *
         *       // Request body metadata
    ...
    export class Resource$Projects$Locations$Environments$Workloads {
         ...
         *
         *   // Do the magic
         *   const res = await composer.projects.locations.environments.workloads.list({
