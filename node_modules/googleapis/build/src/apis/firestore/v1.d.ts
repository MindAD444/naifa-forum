...
export declare namespace firestore_v1 {
    ...
    export class Resource$Projects$Databases {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        clone(params: Params$Resource$Projects$Databases$Clone, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        clone(params?: Params$Resource$Projects$Databases$Clone, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleLongrunningOperation>>;
        clone(params: Params$Resource$Projects$Databases$Clone, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        clone(params: Params$Resource$Projects$Databases$Clone, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunningOperation>, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        clone(params: Params$Resource$Projects$Databases$Clone, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        clone(callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        /**
         * Create a database.
         * @example
         * ```js
