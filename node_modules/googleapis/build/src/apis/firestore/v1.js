...
(function (firestore_v1) {
    ...
    class Resource$Projects$Databases {
        ...
        constructor(context) {
            this.context = context;
            this.backupSchedules = new Resource$Projects$Databases$Backupschedules(this.context);
        ...
        bulkDeleteDocuments(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:bulkDeleteDocuments').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
        ...
        clone(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/databases:clone').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
        ...
        restore(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/databases:restore').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    class Resource$Projects$Databases$Backupschedules {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/backupSchedules').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    firestore_v1.Resource$Projects$Databases$Backupschedules = Resource$Projects$Databases$Backupschedules;
    ...
    class Resource$Projects$Databases$Usercreds {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/userCreds').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
        ...
        resetPassword(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:resetPassword').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    firestore_v1.Resource$Projects$Databases$Usercreds = Resource$Projects$Databases$Usercreds;
    ...
    firestore_v1.Resource$Projects$Locations$Backups = Resource$Projects$Locations$Backups;
})(firestore_v1 || (exports.firestore_v1 = firestore_v1 = {}));
