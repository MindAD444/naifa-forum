...
(function (observability_v1) {
    ...
    class Resource$Projects$Locations {
        ...
        constructor(context) {
            ...
            this.traceScopes = new Resource$Projects$Locations$Tracescopes(this.context);
        }
    ...
    class Resource$Projects$Locations$Tracescopes {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/traceScopes').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    observability_v1.Resource$Projects$Locations$Tracescopes = Resource$Projects$Locations$Tracescopes;
