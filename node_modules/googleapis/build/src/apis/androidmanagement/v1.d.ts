...
export declare namespace androidmanagement_v1 {
    ...
    export class Resource$Enterprises$Policies {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        modifyPolicyApplications(params: Params$Resource$Enterprises$Policies$Modifypolicyapplications, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        modifyPolicyApplications(params?: Params$Resource$Enterprises$Policies$Modifypolicyapplications, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ModifyPolicyApplicationsResponse>>;
        modifyPolicyApplications(params: Params$Resource$Enterprises$Policies$Modifypolicyapplications, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        modifyPolicyApplications(params: Params$Resource$Enterprises$Policies$Modifypolicyapplications, options: MethodOptions | BodyResponseCallback<Schema$ModifyPolicyApplicationsResponse>, callback: BodyResponseCallback<Schema$ModifyPolicyApplicationsResponse>): void;
        modifyPolicyApplications(params: Params$Resource$Enterprises$Policies$Modifypolicyapplications, callback: BodyResponseCallback<Schema$ModifyPolicyApplicationsResponse>): void;
        modifyPolicyApplications(callback: BodyResponseCallback<Schema$ModifyPolicyApplicationsResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        removePolicyApplications(params: Params$Resource$Enterprises$Policies$Removepolicyapplications, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        removePolicyApplications(params?: Params$Resource$Enterprises$Policies$Removepolicyapplications, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$RemovePolicyApplicationsResponse>>;
        removePolicyApplications(params: Params$Resource$Enterprises$Policies$Removepolicyapplications, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        removePolicyApplications(params: Params$Resource$Enterprises$Policies$Removepolicyapplications, options: MethodOptions | BodyResponseCallback<Schema$RemovePolicyApplicationsResponse>, callback: BodyResponseCallback<Schema$RemovePolicyApplicationsResponse>): void;
        removePolicyApplications(params: Params$Resource$Enterprises$Policies$Removepolicyapplications, callback: BodyResponseCallback<Schema$RemovePolicyApplicationsResponse>): void;
        removePolicyApplications(callback: BodyResponseCallback<Schema$RemovePolicyApplicationsResponse>): void;
    }
