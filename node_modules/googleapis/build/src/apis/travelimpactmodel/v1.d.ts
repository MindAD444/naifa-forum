...
export declare namespace travelimpactmodel_v1 {
    ...
    export class Resource$Flights {
         ...
         */
        computeFlightEmissions(params: Params$Resource$Flights$Computeflightemissions, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        computeFlightEmissions(params?: Params$Resource$Flights$Computeflightemissions, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ComputeFlightEmissionsResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        computeScope3FlightEmissions(params: Params$Resource$Flights$Computescope3flightemissions, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        computeScope3FlightEmissions(params?: Params$Resource$Flights$Computescope3flightemissions, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$ComputeScope3FlightEmissionsResponse>>;
        computeScope3FlightEmissions(params: Params$Resource$Flights$Computescope3flightemissions, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        computeScope3FlightEmissions(params: Params$Resource$Flights$Computescope3flightemissions, options: MethodOptions | BodyResponseCallback<Schema$ComputeScope3FlightEmissionsResponse>, callback: BodyResponseCallback<Schema$ComputeScope3FlightEmissionsResponse>): void;
        computeScope3FlightEmissions(params: Params$Resource$Flights$Computescope3flightemissions, callback: BodyResponseCallback<Schema$ComputeScope3FlightEmissionsResponse>): void;
        computeScope3FlightEmissions(callback: BodyResponseCallback<Schema$ComputeScope3FlightEmissionsResponse>): void;
        /**
