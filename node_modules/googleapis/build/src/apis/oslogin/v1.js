...
(function (oslogin_v1) {
    ...
    oslogin_v1.Resource$Projects = Resource$Projects;
        ...
        signSshPublicKey(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}:signSshPublicKey').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    oslogin_v1.Resource$Projects$Locations = Resource$Projects$Locations;
...
})(oslogin_v1 || (exports.oslogin_v1 = oslogin_v1 = {}));
