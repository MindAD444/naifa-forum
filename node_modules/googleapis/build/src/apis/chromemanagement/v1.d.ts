...
export declare namespace chromemanagement_v1 {
    ...
    export class Resource$Customers$Apps {
         ...
         */
        countChromeAppRequests(params: Params$Resource$Customers$Apps$Countchromeapprequests, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countChromeAppRequests(params?: Params$Resource$Customers$Apps$Countchromeapprequests, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountChromeAppRequestsResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchDevicesRequestingExtension(params: Params$Resource$Customers$Apps$Fetchdevicesrequestingextension, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchDevicesRequestingExtension(params?: Params$Resource$Customers$Apps$Fetchdevicesrequestingextension, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1FetchDevicesRequestingExtensionResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        fetchUsersRequestingExtension(params: Params$Resource$Customers$Apps$Fetchusersrequestingextension, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        fetchUsersRequestingExtension(params?: Params$Resource$Customers$Apps$Fetchusersrequestingextension, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1FetchUsersRequestingExtensionResponse>>;
    ...
    export class Resource$Customers$Apps$Android {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Customers$Apps$Android$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Customers$Apps$Android$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1AppDetails>>;
    ...
    export class Resource$Customers$Apps$Chrome {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Customers$Apps$Chrome$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Customers$Apps$Chrome$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1AppDetails>>;
    ...
    export class Resource$Customers$Apps$Web {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Customers$Apps$Web$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Customers$Apps$Web$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1AppDetails>>;
    ...
    export class Resource$Customers$Certificateprovisioningprocesses {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        claim(params: Params$Resource$Customers$Certificateprovisioningprocesses$Claim, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        claim(params?: Params$Resource$Customers$Certificateprovisioningprocesses$Claim, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ClaimCertificateProvisioningProcessResponse>>;
        claim(params: Params$Resource$Customers$Certificateprovisioningprocesses$Claim, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        claim(params: Params$Resource$Customers$Certificateprovisioningprocesses$Claim, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ClaimCertificateProvisioningProcessResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ClaimCertificateProvisioningProcessResponse>): void;
        claim(params: Params$Resource$Customers$Certificateprovisioningprocesses$Claim, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ClaimCertificateProvisioningProcessResponse>): void;
        claim(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ClaimCertificateProvisioningProcessResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Customers$Certificateprovisioningprocesses$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Customers$Certificateprovisioningprocesses$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1CertificateProvisioningProcess>>;
        get(params: Params$Resource$Customers$Certificateprovisioningprocesses$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Customers$Certificateprovisioningprocesses$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1CertificateProvisioningProcess>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1CertificateProvisioningProcess>): void;
        get(params: Params$Resource$Customers$Certificateprovisioningprocesses$Get, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1CertificateProvisioningProcess>): void;
        get(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1CertificateProvisioningProcess>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setFailure(params: Params$Resource$Customers$Certificateprovisioningprocesses$Setfailure, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        setFailure(params?: Params$Resource$Customers$Certificateprovisioningprocesses$Setfailure, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1SetFailureResponse>>;
        setFailure(params: Params$Resource$Customers$Certificateprovisioningprocesses$Setfailure, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        setFailure(params: Params$Resource$Customers$Certificateprovisioningprocesses$Setfailure, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1SetFailureResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1SetFailureResponse>): void;
        setFailure(params: Params$Resource$Customers$Certificateprovisioningprocesses$Setfailure, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1SetFailureResponse>): void;
        setFailure(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1SetFailureResponse>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        signData(params: Params$Resource$Customers$Certificateprovisioningprocesses$Signdata, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        signData(params?: Params$Resource$Customers$Certificateprovisioningprocesses$Signdata, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleLongrunningOperation>>;
        signData(params: Params$Resource$Customers$Certificateprovisioningprocesses$Signdata, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        signData(params: Params$Resource$Customers$Certificateprovisioningprocesses$Signdata, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunningOperation>, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        signData(params: Params$Resource$Customers$Certificateprovisioningprocesses$Signdata, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        signData(callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        uploadCertificate(params: Params$Resource$Customers$Certificateprovisioningprocesses$Uploadcertificate, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        uploadCertificate(params?: Params$Resource$Customers$Certificateprovisioningprocesses$Uploadcertificate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1UploadCertificateResponse>>;
        uploadCertificate(params: Params$Resource$Customers$Certificateprovisioningprocesses$Uploadcertificate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        uploadCertificate(params: Params$Resource$Customers$Certificateprovisioningprocesses$Uploadcertificate, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1UploadCertificateResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1UploadCertificateResponse>): void;
        uploadCertificate(params: Params$Resource$Customers$Certificateprovisioningprocesses$Uploadcertificate, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1UploadCertificateResponse>): void;
        uploadCertificate(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1UploadCertificateResponse>): void;
    }
    ...
    export class Resource$Customers$Certificateprovisioningprocesses$Operations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Customers$Certificateprovisioningprocesses$Operations$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Customers$Certificateprovisioningprocesses$Operations$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleLongrunningOperation>>;
        get(params: Params$Resource$Customers$Certificateprovisioningprocesses$Operations$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Customers$Certificateprovisioningprocesses$Operations$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunningOperation>, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        get(params: Params$Resource$Customers$Certificateprovisioningprocesses$Operations$Get, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
    ...
    export class Resource$Customers$Profiles {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Customers$Profiles$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Customers$Profiles$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleProtobufEmpty>>;
        delete(params: Params$Resource$Customers$Profiles$Delete, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        delete(params: Params$Resource$Customers$Profiles$Delete, options: MethodOptions | BodyResponseCallback<Schema$GoogleProtobufEmpty>, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
        delete(params: Params$Resource$Customers$Profiles$Delete, callback: BodyResponseCallback<Schema$GoogleProtobufEmpty>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Customers$Profiles$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Customers$Profiles$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfile>>;
        get(params: Params$Resource$Customers$Profiles$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Customers$Profiles$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfile>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfile>): void;
        get(params: Params$Resource$Customers$Profiles$Get, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfile>): void;
        get(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfile>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Customers$Profiles$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Customers$Profiles$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ListChromeBrowserProfilesResponse>>;
        list(params: Params$Resource$Customers$Profiles$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Customers$Profiles$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListChromeBrowserProfilesResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListChromeBrowserProfilesResponse>): void;
        list(params: Params$Resource$Customers$Profiles$List, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListChromeBrowserProfilesResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListChromeBrowserProfilesResponse>): void;
    }
    ...
    export class Resource$Customers$Profiles$Commands {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Customers$Profiles$Commands$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Customers$Profiles$Commands$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfileCommand>>;
        create(params: Params$Resource$Customers$Profiles$Commands$Create, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        create(params: Params$Resource$Customers$Profiles$Commands$Create, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfileCommand>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfileCommand>): void;
        create(params: Params$Resource$Customers$Profiles$Commands$Create, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfileCommand>): void;
        create(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfileCommand>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Customers$Profiles$Commands$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Customers$Profiles$Commands$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfileCommand>>;
        get(params: Params$Resource$Customers$Profiles$Commands$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Customers$Profiles$Commands$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfileCommand>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfileCommand>): void;
        get(params: Params$Resource$Customers$Profiles$Commands$Get, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfileCommand>): void;
        get(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ChromeBrowserProfileCommand>): void;
        /**
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Customers$Profiles$Commands$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Customers$Profiles$Commands$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1ListChromeBrowserProfileCommandsResponse>>;
        list(params: Params$Resource$Customers$Profiles$Commands$List, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        list(params: Params$Resource$Customers$Profiles$Commands$List, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListChromeBrowserProfileCommandsResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListChromeBrowserProfileCommandsResponse>): void;
        list(params: Params$Resource$Customers$Profiles$Commands$List, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListChromeBrowserProfileCommandsResponse>): void;
        list(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1ListChromeBrowserProfileCommandsResponse>): void;
    }
    ...
    export class Resource$Customers$Reports {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countChromeBrowsersNeedingAttention(params: Params$Resource$Customers$Reports$Countchromebrowsersneedingattention, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countChromeBrowsersNeedingAttention(params?: Params$Resource$Customers$Reports$Countchromebrowsersneedingattention, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountChromeBrowsersNeedingAttentionResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countChromeCrashEvents(params: Params$Resource$Customers$Reports$Countchromecrashevents, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countChromeCrashEvents(params?: Params$Resource$Customers$Reports$Countchromecrashevents, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountChromeCrashEventsResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countChromeDevicesReachingAutoExpirationDate(params: Params$Resource$Customers$Reports$Countchromedevicesreachingautoexpirationdate, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countChromeDevicesReachingAutoExpirationDate(params?: Params$Resource$Customers$Reports$Countchromedevicesreachingautoexpirationdate, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountChromeDevicesReachingAutoExpirationDateResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countChromeDevicesThatNeedAttention(params: Params$Resource$Customers$Reports$Countchromedevicesthatneedattention, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countChromeDevicesThatNeedAttention(params?: Params$Resource$Customers$Reports$Countchromedevicesthatneedattention, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountChromeDevicesThatNeedAttentionResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countChromeHardwareFleetDevices(params: Params$Resource$Customers$Reports$Countchromehardwarefleetdevices, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countChromeHardwareFleetDevices(params?: Params$Resource$Customers$Reports$Countchromehardwarefleetdevices, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountChromeHardwareFleetDevicesResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countChromeVersions(params: Params$Resource$Customers$Reports$Countchromeversions, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countChromeVersions(params?: Params$Resource$Customers$Reports$Countchromeversions, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountChromeVersionsResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countInstalledApps(params: Params$Resource$Customers$Reports$Countinstalledapps, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countInstalledApps(params?: Params$Resource$Customers$Reports$Countinstalledapps, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountInstalledAppsResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countPrintJobsByPrinter(params: Params$Resource$Customers$Reports$Countprintjobsbyprinter, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countPrintJobsByPrinter(params?: Params$Resource$Customers$Reports$Countprintjobsbyprinter, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountPrintJobsByPrinterResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        countPrintJobsByUser(params: Params$Resource$Customers$Reports$Countprintjobsbyuser, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        countPrintJobsByUser(params?: Params$Resource$Customers$Reports$Countprintjobsbyuser, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1CountPrintJobsByUserResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        enumeratePrintJobs(params: Params$Resource$Customers$Reports$Enumerateprintjobs, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        enumeratePrintJobs(params?: Params$Resource$Customers$Reports$Enumerateprintjobs, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1EnumeratePrintJobsResponse>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        findInstalledAppDevices(params: Params$Resource$Customers$Reports$Findinstalledappdevices, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        findInstalledAppDevices(params?: Params$Resource$Customers$Reports$Findinstalledappdevices, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1FindInstalledAppDevicesResponse>>;
    ...
    export class Resource$Customers$Telemetry$Devices {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Customers$Telemetry$Devices$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Customers$Telemetry$Devices$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1TelemetryDevice>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Customers$Telemetry$Devices$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Customers$Telemetry$Devices$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1ListTelemetryDevicesResponse>>;
    ...
    export class Resource$Customers$Telemetry$Events {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Customers$Telemetry$Events$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Customers$Telemetry$Events$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1ListTelemetryEventsResponse>>;
    ...
    export class Resource$Customers$Telemetry$Notificationconfigs {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        create(params: Params$Resource$Customers$Telemetry$Notificationconfigs$Create, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        create(params?: Params$Resource$Customers$Telemetry$Notificationconfigs$Create, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1TelemetryNotificationConfig>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        delete(params: Params$Resource$Customers$Telemetry$Notificationconfigs$Delete, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        delete(params?: Params$Resource$Customers$Telemetry$Notificationconfigs$Delete, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleProtobufEmpty>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Customers$Telemetry$Notificationconfigs$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Customers$Telemetry$Notificationconfigs$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1ListTelemetryNotificationConfigsResponse>>;
    ...
    export class Resource$Customers$Telemetry$Users {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        get(params: Params$Resource$Customers$Telemetry$Users$Get, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        get(params?: Params$Resource$Customers$Telemetry$Users$Get, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1TelemetryUser>>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Customers$Telemetry$Users$List, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        list(params?: Params$Resource$Customers$Telemetry$Users$List, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementV1ListTelemetryUsersResponse>>;
    ...
    export class Resource$Customers$Thirdpartyprofileusers {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        move(params: Params$Resource$Customers$Thirdpartyprofileusers$Move, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        move(params?: Params$Resource$Customers$Thirdpartyprofileusers$Move, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$GoogleChromeManagementVersionsV1MoveThirdPartyProfileUserResponse>>;
        move(params: Params$Resource$Customers$Thirdpartyprofileusers$Move, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        move(params: Params$Resource$Customers$Thirdpartyprofileusers$Move, options: MethodOptions | BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1MoveThirdPartyProfileUserResponse>, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1MoveThirdPartyProfileUserResponse>): void;
        move(params: Params$Resource$Customers$Thirdpartyprofileusers$Move, callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1MoveThirdPartyProfileUserResponse>): void;
        move(callback: BodyResponseCallback<Schema$GoogleChromeManagementVersionsV1MoveThirdPartyProfileUserResponse>): void;
    }
