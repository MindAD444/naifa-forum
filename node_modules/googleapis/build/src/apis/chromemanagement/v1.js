...
(function (chromemanagement_v1) {
    ...
    class Resource$Customers$Certificateprovisioningprocesses {
        context;
        operations;
        constructor(context) {
            this.context = context;
            this.operations =
                new Resource$Customers$Certificateprovisioningprocesses$Operations(this.context);
        }
        ...
        setFailure(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:setFailure').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
        ...
        signData(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:signData').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
        ...
        uploadCertificate(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:uploadCertificate').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    chromemanagement_v1.Resource$Customers$Certificateprovisioningprocesses = Resource$Customers$Certificateprovisioningprocesses;
    class Resource$Customers$Certificateprovisioningprocesses$Operations {
        context;
        constructor(context) {
            this.context = context;
        }
    ...
    chromemanagement_v1.Resource$Customers$Certificateprovisioningprocesses$Operations = Resource$Customers$Certificateprovisioningprocesses$Operations;
    ...
    class Resource$Customers$Profiles$Commands {
        context;
        constructor(context) {
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+parent}/commands').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: '',
                }, options),
                params,
    ...
    chromemanagement_v1.Resource$Customers$Profiles$Commands = Resource$Customers$Profiles$Commands;
    ...
    class Resource$Customers$Thirdpartyprofileusers {
        context;
        constructor(context) {
            this.context = context;
        }
    ...
    chromemanagement_v1.Resource$Customers$Thirdpartyprofileusers = Resource$Customers$Thirdpartyprofileusers;
    ...
    chromemanagement_v1.Resource$Operations = Resource$Operations;
