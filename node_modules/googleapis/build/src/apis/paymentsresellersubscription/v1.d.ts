...
export declare namespace paymentsresellersubscription_v1 {
    ...
    export class Resource$Partners$Subscriptions$Lineitems {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        patch(params: Params$Resource$Partners$Subscriptions$Lineitems$Patch, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        patch(params?: Params$Resource$Partners$Subscriptions$Lineitems$Patch, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$SubscriptionLineItem>>;
        patch(params: Params$Resource$Partners$Subscriptions$Lineitems$Patch, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        patch(params: Params$Resource$Partners$Subscriptions$Lineitems$Patch, options: MethodOptions | BodyResponseCallback<Schema$SubscriptionLineItem>, callback: BodyResponseCallback<Schema$SubscriptionLineItem>): void;
        patch(params: Params$Resource$Partners$Subscriptions$Lineitems$Patch, callback: BodyResponseCallback<Schema$SubscriptionLineItem>): void;
